...
RsCount = 0
Pack_Name = "SAP"
Set objRs=objConn.Execute("Select * from Calls WHERE (CALL_SERVICED_BY = 'RV' or CALL_SERVICED_BY = 'CH' or CALL_SERVICED_BY = 'CB' or CALL_SERVICED_BY = 'JL' or CALL_SERVICED_BY = 'NS') and Closed = 'No' and  Call_Type =  'Help' and Package_Name Not Like '%" & Pack_Name &"%' order by Ticket_Number")
Set rsCount=objConn.Execute("SELECT Count(*) from Calls WHERE (CALL_SERVICED_BY = 'RV' or CALL_SERVICED_BY = 'CH' or CALL_SERVICED_BY = 'CB' or CALL_SERVICED_BY = 'JL' or CALL_SERVICED_BY = 'NS') and Closed = 'No' and Call_Type =  'Help' and Package_Name Not Like '%" & Pack_Name &"%'")
