...
<table>
<tr>
<td valign="top">By Date:
</td>
<td>
<table border="1">
<form method="post" action="workerclosedticketcountbydate.asp" name="ViewWork">
<tr>
	<td>Start Date:</td>
...
End select
 %>	</select></td>
	...
	i = 1
		While i <> 32
			If i = strDay Then
				Response.Write "<option value=" & i & " selected>" & i & vbcrlf
			Else
...
Select Case strYear
	...
	Case 2003
	response.write "<Option value=99>1999 <Option value=00>2000 <Option selected value=01>2001 <Option value=02>2002 <Option selected value=03>2003 <Option value=04>2004 <Option value=05>2005 <Option value=06>2006"	
	Case 2004
	response.write "<Option value=99>1999 <Option value=00>2000 <Option selected value=01>2001 <Option value=02>2002 <Option value=03>2003 <Option selected value=04>2004 <Option value=05>2005 <Option value=06>2006"	
    Case 2005
	response.write "<Option value=99>1999 <Option value=00>2000 <Option selected value=01>2001 <Option value=02>2002 <Option value=03>2003 <Option value=04>2004 <Option selected value=05>2005 <Option value=06>2006"			
	Case 2006
	response.write "<Option value=99>1999 <Option value=00>2000 <Option selected value=01>2001 <Option value=02>2002 <Option value=03>2003 <Option value=04>2004 <Option value=05>2005 <Option selected value=06>2006"	
End select
 %>
...
--->
	<td colspan="2" align="Right"><input type="submit" value="Search" name="B1"></td>
</tr>
