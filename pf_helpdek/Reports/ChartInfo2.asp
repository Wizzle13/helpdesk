...
Set JanCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#01/01/02# And (Calls.Date_Opened)<#01/31/02# And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#01/01/02# And (Calls.Date_Closed)<#01/31/02#  And (Country='US' or Country='CA'))) ;")
Set JanHCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#01/01/02# And (Calls.Date_Opened)<#01/31/02#  And (Calls.Call_Type)='Help' And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#01/01/02# And (Calls.Date_Closed)<#01/31/02#  And (Calls.Call_Type)='Help' And (Country='US' or Country='CA'))) ;")
Set JanRCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#01/01/02# And (Calls.Date_Opened)<#01/31/02#  And (Calls.Call_Type)='Request' And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#01/01/02# And (Calls.Date_Closed)<#01/31/02#  And (Calls.Call_Type)='Request' And (Country='US' or Country='CA'))) ;")
...
Set objConn=Server.CreateObject("ADODB.Connection")
objConn.Open "DSN=Helpdesk2"
Set FebCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#02/01/02# And (Calls.Date_Opened)<#02/281/02# And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#02/01/02# And (Calls.Date_Closed)<#02/28/02#  And (Country='US' or Country='CA'))) ;")
Set FebHCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#02/01/02# And (Calls.Date_Opened)<#02/28/02#  And (Calls.Call_Type)='Help' And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#02/01/02# And (Calls.Date_Closed)<#02/28/02#  And (Calls.Call_Type)='Help' And (Country='US' or Country='CA'))) ;")
Set FebRCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#02/01/02# And (Calls.Date_Opened)<#02/28/02#  And (Calls.Call_Type)='Request' And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#02/01/02# And (Calls.Date_Closed)<#02/28/02#  And (Calls.Call_Type)='Request' And (Country='US' or Country='CA'))) ;")Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'February' and Year='"&ChartYear&"' and HelpDesk='US'")
...
Set MarCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#03/01/02# And (Calls.Date_Opened)<#03/31/02# And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#03/01/02# And (Calls.Date_Closed)<#03/31/02#  And (Country='US' or Country='CA'))) ;")
Set MarHCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#03/01/02# And (Calls.Date_Opened)<#03/31/02#  And (Calls.Call_Type)='Help' And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#03/01/02# And (Calls.Date_Closed)<#03/31/02#  And (Calls.Call_Type)='Help' And (Country='US' or Country='CA'))) ;")
Set MarRCount=objConn.Execute("SELECT Count(*) FROM Calls WHERE (((Calls.Date_Opened)>#03/01/02# And (Calls.Date_Opened)<#03/31/02#  And (Calls.Call_Type)='Request' And (Country='US' or Country='CA'))) OR (((Calls.Date_Closed)>#03/01/02# And (Calls.Date_Closed)<#03/31/02#  And (Calls.Call_Type)='Request' And (Country='US' or Country='CA'))) ;")
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'April' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'April' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'April', Year= '"&ChartYear&"', TotalTickets= '" & AprCount(0) & "', HelpTickets= '" & AprHCount(0) & "', RequestTickets= '" & AprRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('April','"& ChartYear & "','"& AprCount(0) & "','"& AprHCount(0) & "','"& AprRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'May' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'May' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'May', Year= '"&ChartYear&"', TotalTickets= '" & MayCount(0) & "', HelpTickets= '" & MayHCount(0) & "', RequestTickets= '" & MayRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('May','"& ChartYear & "','"& MayCount(0) & "','"& MayHCount(0) & "','"& MayRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'June' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'June' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'June', Year= '"&ChartYear&"', TotalTickets= '" & JunCount(0) & "', HelpTickets= '" & JunHCount(0) & "', RequestTickets= '" & JunRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('June','"& ChartYear & "','"& JunCount(0) & "','"& JunHCount(0) & "','"& JunRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'July' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'July' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'July', Year= '"&ChartYear&"', TotalTickets= '" & JulCount(0) & "', HelpTickets= '" & JulHCount(0) & "', RequestTickets= '" & JulRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('July','"& ChartYear & "','"& JulCount(0) & "','"& JulHCount(0) & "','"& JulRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'August' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'August' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'August', Year= '"&ChartYear&"', TotalTickets= '" & AugCount(0) & "', HelpTickets= '" & AugHCount(0) & "', RequestTickets= '" & AugRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('August','"& ChartYear & "','"& AugCount(0) & "','"& AugHCount(0) & "','"& AugRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'September' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'September' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'September', Year= '"&ChartYear&"', TotalTickets= '" & SepCount(0) & "', HelpTickets= '" & SepHCount(0) & "', RequestTickets= '" & SepRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('September','"& ChartYear & "','"& SepCount(0) & "','"& SepHCount(0) & "','"& SepRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'October' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'October' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'October', Year= '"&ChartYear&"', TotalTickets= '" & OctCount(0) & "', HelpTickets= '" & OctHCount(0) & "', RequestTickets= '" & OctRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('October','"& ChartYear & "','"& OctCount(0) & "','"& OctHCount(0) & "','"& OctRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'November' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'November' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'November', Year= '"&ChartYear&"', TotalTickets= '" & NovCount(0) & "', HelpTickets= '" & NovHCount(0) & "', RequestTickets= '" & NovRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('November','"& ChartYear & "','"& NovCount(0) & "','"& NovHCount(0) & "','"& NovRCount(0) & "','US');"
...
Set Count=objConn.Execute("SELECT Count(*) FROM ChartInfo WHERE Month = 'December' and Year='"&ChartYear&"' and HelpDesk='US'")
Set ObjRec=objConn.Execute("SELECT ID FROM ChartInfo WHERE Month = 'December' and Year='"&ChartYear&"' and HelpDesk='US'")
IF Count(0) >0 then
Count(0)
sql = "UPDATE ChartInfo SET  Month= 'December', Year= '"&ChartYear&"', TotalTickets= '" & DecCount(0) & "', HelpTickets= '" & DecHCount(0) & "', RequestTickets= '" & DecRCount(0) & "', HelpDesk= 'US' WHERE ID=" & ObjRec("ID") & ";"
	
objConn.Execute(sql)
Else
sql = "INSERT INTO ChartInfo(Month, Year, TotalTickets, HelpTickets, RequestTickets, HelpDesk) VALUES('December','"& ChartYear & "','"& DecCount(0) & "','"& DecHCount(0) & "','"& DecRCount(0) & "','US');"
