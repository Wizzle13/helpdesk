...
<option value=None selected>Select User's Department
<option value=None>-----------------
<%
		While Not objRs.EOF
...
Set objRs=objConn.Execute("Select * from Domains Order by CountryFull")
 %>
<tr>
<td>Country:</td><td><Select  name=Country><Option Selected Value=None>Select User's Country<Option Value=None>---------------------
<%
		While Not objRs.EOF
