...
%>
<tr>
<td valign="top">By Date Due:
</td>
<td>
<table border="1">
<form method="post" action="SearchDateDue.asp" name="ViewWork">
<tr>
	<td>Start Date:</td>
...
Response.Write "<td colspan='2'><Select name=Worker_ID><Option Selected Value='All'>All"
	...
	Set objConn = Nothing	
Response.Write "</td>"
Response.Write "<td colspan='2'><input type=radio value =Current name=View checked>Current<br><input type=radio value =OverDue name=View checked>Over Due<br><input type=radio value=Blank name=View>Blank</td>"	
	 %>
