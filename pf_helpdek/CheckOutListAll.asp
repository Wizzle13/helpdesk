...
While Not objRs.EOF
	...
	Response.Write "<td>Location</td></tr>"
		...
		Set objRs2=objConn.Execute("Select * from CheckOutList  Where CheckoutItemID="& objRs("ID") &" order by Date_Out,Time_Out,Date_In,Time_In")
	
		While Not objRs2.EOF
		If objRs2("Returned") = "Yes" Then
			Response.Write "<tr bgcolor=lightgrey>"
		Else
			Response.Write "<tr>"
		End If
		Response.Write "<td><a href=""CheckoutModify.asp?Num=" & objRs2("ID") & """>Modify</td>"
